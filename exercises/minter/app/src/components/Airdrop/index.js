...
import {programID, dummyMintPk, dummyMintPkBump,nftMintPk,nftMintPkBump} from '../../config/config.js';
import idl from '../../config/token_minter.json';
...
const AirDrop: FC = ({tokenName, reload, setReload, network, setNetwork}) => {
  ...
  const handleSubmitSplNFT = async (event) => {
    event.preventDefault();
    await mintNft( nftMintPk, nftMintPkBump);
  };
  ...
  return (
    <div className="airdrop-container">
      <div className="airdrop-wrapper">
        ...
        <p>Mint PK: 262F743nVr1rNLpReAwgoVbnQqu6mYAKUaK8sNCgsYdd</p>
